...
[uuid_value, uuid_gvalue2, uuid_slouch]); //Add in reading for the y and z characteristics
...
//
let readData = async (characteristic, gcharacteristic2, slouchchar) => {
  ...
  console.log(value.readFloatLE(0)+","+gvalue2.readFloatLE(0));

  // read data again in t milliseconds
  setTimeout(() => {
    readData(characteristic, gcharacteristic2, slouchchar)
   }, 10);
}
